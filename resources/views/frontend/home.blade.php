            ...
            <div class="row g-2">
                <div class="col-lg-8 col-md-12 left">
                    <div class="inner">
                        <div class="photo">
                            <div class="bg"></div>
                            <img src="{{ asset('/') }}frontend/assets/uploads/n1.jpg" alt="">
                            <div class="text">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="inner inner-right">
                        <div class="photo">
                            <div class="bg"></div>
                            <img src="{{ asset('/') }}frontend/assets/uploads/n2.jpg" alt="">
                            <div class="text">
                                <div class="text-inner">
                                    <div class="category">
                                        <span class="badge bg-success badge-sm">Politics</span>
                    ...
                    <div class="inner inner-right">
                        <div class="photo">
                            <div class="bg"></div>
                            <img src="{{ asset('/') }}frontend/assets/uploads/n3.jpg" alt="">
                            <div class="text">
                                <div class="text-inner">
                                    <div class="category">
                                        <span class="badge bg-success badge-sm">Politics</span>
                        ...
                        <div class="news-total-item">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="left-side">
                                        <div class="photo">
                                            <img src="{{ asset('/') }}frontend/assets/uploads/n6.jpg" alt="">
                                        </div>
                                        <div class="category">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="right-side">
                                        <div class="right-side-item">
                                            <div class="left">
                                                <img src="{{ asset('/') }}frontend/assets/uploads/n5.jpg" alt="">
                                            </div>
                                            <div class="right">
                                                <div class="category">
                                                    <span class="badge bg-success">International</span>
                    ...
                    <div class="sidebar">
                        ...
                        <div class="widget">
                            <div class="ad-sidebar">
                                <a href=""><img src="{{ asset('/') }}frontend/assets/uploads/ad-3.png" alt=""></a>
                            </div>
                        </div>
                            ...
                            <div class="news">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                        ...
                                        <div class="news-item">
                                            <div class="left">
                                                <img src="{{ asset('/') }}frontend/assets/uploads/n7.jpg" alt="">
                                            </div>
                                            <div class="right">
                                                <div class="category">
                                                    <span class="badge bg-success">Business</span>
                                        ...
                                        <div class="news-item">
                                            <div class="left">
                                                <img src="{{ asset('/') }}frontend/assets/uploads/n8.jpg" alt="">
                                            </div>
                                            <div class="right">
                                                <div class="category">
